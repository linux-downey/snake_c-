...
(*.[0-9]*)
	...
	if test ! -f /home/downey/workspace_downey/snake_c++/snake_c-/ncurses-6.1/man_alias.sed ; then
cat >>/home/downey/workspace_downey/snake_c++/snake_c-/ncurses-6.1/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/downey/workspace_downey/snake_c++/snake_c-/ncurses-6.1/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/downey/workspace_downey/snake_c++/snake_c-/ncurses-6.1/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	cf_target=`grep "^$cf_source" /home/downey/workspace_downey/snake_c++/snake_c-/ncurses-6.1/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /home/downey/workspace_downey/snake_c++/snake_c-/ncurses-6.1/man_alias.sed \
		< $i | sed -f /home/downey/workspace_downey/snake_c++/snake_c-/ncurses-6.1/edit_man.sed >$TMP
